    ...
    return new ListView(
      ...
      children: <Widget>[
        ...
        ListTile(
          ...
          title: Padding(
            padding: const EdgeInsets.all(8.0),
            child: Text("Framework architecture :",
              style: TextStyle(
                  fontFamily: 'PTSerif',
                  fontWeight: FontWeight.bold
              ),
        ...
        ListTile(
          ...
          title: Padding(
            padding: const EdgeInsets.all(8.0),
            child: Text("Road Map to learn Flutter :",
              style: TextStyle(
                  fontFamily: 'PTSerif',
                  fontWeight: FontWeight.bold
              ),
        ...
        ListTile(
          ...
          title: Padding(
            padding: const EdgeInsets.all(8.0),
            child: Text("How long will it take to learn flutter?",
              style: TextStyle(
                  fontFamily: 'PTSerif',
                  fontWeight: FontWeight.bold
              ),
          ...
          subtitle: Padding(
            padding: const EdgeInsets.all(8.0),
            child: Text('It would take you approximately two weeks to get through it. \n(or two days if you are really passionate about Flutter).'
              ,
              style: TextStyle(
                fontFamily: 'PTSerif',
                fontStyle: FontStyle.italic,
        ...
        ListTile(
          ...
          title: Padding(
            padding: const EdgeInsets.all(8.0),
            child: Text("Best Online Resources to Learn Flutter :",
              style: TextStyle(
                  fontFamily: 'PTSerif',
                  fontWeight: FontWeight.bold
              ),
